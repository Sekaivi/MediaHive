        ...
        <div class="article-card">
          ...
          <div class="action-buttons">
            ...
            <button class="action-btn share-btn" title="Partager">
              <img src="public/images/share1.png" alt="Partager" class="btn-icon" data-hover="public/images/share2.png" data-clicked="public/images/share3.png">
            </button>
            <button class="action-btn view-btn" title="Voir l'article" onclick="window.open('<?= $article['link'] ?>', '_blank')">
              <img src="public/images/link1.png" alt="Voir l'article" class="btn-icon" data-hover="public/images/link2.png" data-clicked="public/images/link3.png">
            </button>
            <button class="action-btn fav-btn" title="Favoris">
              <img src="public/images/fav1.png" alt="Favoris" class="btn-icon" data-hover="public/images/fav2.png" data-clicked="public/images/fav3.png">
            </button>
          </div>
        </div>
      <?php endforeach; ?>
